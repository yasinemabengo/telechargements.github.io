            ...
            <tr>
                <td style="position: sticky; left: 0; background-color: #fff; z-index: 1;">
                    <div class="btn-group btn-group-sm" role="group">
                        ...
                        <button class="btn btn-success" onclick="window.open('../card/card_agent_tcpdf.php?id=${agent.id_agent}', '_blank')" title="Générer carte">
                            <i class="bi bi-credit-card"></i>
                        </button>
                        <button class="btn btn-warning" onclick="window.location.href='../views/ajout_agent.php?edit=${agent.id_agent}'" title="Modifier">
