...
function saveFaculte() {
    ...
    $.ajax({
        ...
        data: formData,
        success: function(response) {
            $('#modalAddFaculte').modal('hide') // BS4;
...
function updateFaculte() {
    ...
    $.ajax({
        ...
        data: formData,
        success: function(response) {
            $('#modalEditFaculte').modal('hide') // BS4;
            loadFacultes();
            loadAllFacultesForSelects();
...
function saveFiliere() {
    ...
    $.ajax({
        ...
        data: formData,
        success: function(response) {
            $('#modalAddFiliere').modal('hide') // BS4;
...
function updateFiliere() {
    ...
    $.ajax({
        ...
        data: formData,
        success: function(response) {
            $('#modalEditFiliere').modal('hide') // BS4;
            loadFilieres();
            loadAllFilieresForSelects();
...
function savePromotion() {
    ...
    $.ajax({
        ...
        data: formData,
        success: function(response) {
            $('#modalAddPromotion').modal('hide') // BS4;
...
function updatePromotion() {
    ...
    $.ajax({
        ...
        data: formData,
        success: function(response) {
            $('#modalEditPromotion').modal('hide') // BS4;
            loadPromotions();
            loadAllPromotionsForSelects();
...
function saveEtudiant() {
    ...
    $.ajax({
        ...
        data: formData,
        success: function(response) {
            $('#modalAddEtudiant').modal('hide') // BS4;
...
function updateEtudiant() {
    ...
    $.ajax({
        ...
        data: formData,
        success: function(response) {
            $('#modalEditEtudiant').modal('hide') // BS4;
            loadEtudiants();
            loadAllEtudiantsForSelects();
...
function saveEnseignant() {
    ...
    $.ajax({
        ...
        data: formData,
        success: function(response) {
            $('#modalAddEnseignant').modal('hide') // BS4;
...
function editEnseignant(id) {
    $.ajax({
        ...
        success: function(response) {
            ...
            $('#modalEditEnseignant').modal('show');
        }
    });
}
...
function updateEnseignant() {
    ...
    $.ajax({
        ...
        data: formData,
        success: function(response) {
            $('#modalEditEnseignant').modal('hide') // BS4;
            loadEnseignants();
            loadAllEnseignantsForSelects();
...
function saveInscription() {
    ...
    $.ajax({
        ...
        data: formData,
        success: function(response) {
            $('#modalAddInscription').modal('hide') // BS4;
...
function editInscription(id) {
    $.ajax({
        ...
        success: function(response) {
            ...
            $('#modalEditInscription').modal('show');
        }
    });
}
...
function updateInscription() {
    ...
    $.ajax({
        ...
        data: formData,
        success: function(response) {
            $('#modalEditInscription').modal('hide') // BS4;
            loadInscriptions();
...
function savePaiement() {
    ...
    $.ajax({
        ...
        data: formData,
        success: function(response) {
            $('#modalAddPaiement').modal('hide') // BS4;
...
function updatePaiement() {
    ...
    $.ajax({
        ...
        data: formData,
        success: function(response) {
            $('#modalEditPaiement').modal('hide') // BS4;
            loadPaiements();
